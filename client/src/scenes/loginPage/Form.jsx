...
const Form = () => {
    ...
    const register = async (values, onSubmitProps) => {
        // the code below allows us send form info with image
    ...
    <Formik onSubmit={handleFormSubmit} initialValues={isLogin ? initialValuesLogin : initialValuesRegister}
        ...
        {({
            ...
            <form onSubmit={handleSubmit}>
                <Box display="grid" gap="30px" gridTemplateColumns="repeat(4,minmax(0,1fr)" sr={{
                    ...
                    {isRegister && (
                        <>
                            ...
                            <TextField label="last name" onBlur={handleBlur} onChange={handleChange} value={values.lastName}
                                name="lastName" error={Boolean(touched.lastName) && Boolean(errors.lasttName)}
